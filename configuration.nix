...
# Use this to configure your system environment (it replaces /etc/nixos/configuration.nix)
{
  ...
  in {
    # system versionning and garbage collection
    gc = {
      automatic = true;
      dates = "weekly";
  ...
  networking.hostName = "dg-nixos"; # Define your hostname.
  ...
  stylix = {
    ...
    # - try a theme that doesnt work
    # - rebuild
    # - go to the directory indicated in the error
  ...
  # Laptop nvidia configuration
  # hardware dependant but not autogenerated
  hardware = {
    graphics = {
      enable = true;
      enable32Bit = true;
